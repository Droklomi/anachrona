...
const styles = `
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .lp-box {
    ...
    width:100%;
    max-width:480px;
    background:linear-gradient(145deg,rgba(26,18,8,0.9),rgba(13,13,26,0.95));
    border:1px solid rgba(201,168,76,0.2);
    padding:clamp(32px,5vw,52px);
    box-shadow:0 40px 100px rgba(0,0,0,0.7), 0 0 60px rgba(201,168,76,0.04);
    animation:lp-fadein 0.8s cubic-bezier(0.16,1,0.3,1) both;
  }
  ...
  .lp-logo img { height:64px; width:auto; }
...
export default function LoginPage() {
  ...
  const logoExists = true; // passe à false si pas de logo
